...
//        parameters.setColorEffect(Camera.Parameters.EFFECT_MONO); // black and white
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            int startY = row; // which row in the bitmap to analyse to read
            ...
            int error = COMTop - 320;
            control = 100*(1-error/320);
    ...
    protected void onResume() {
        ...
        if (sPort == null) {
            ...
            try {
                ...
                String sendString = String.valueOf(control) + '\n';
                try{
