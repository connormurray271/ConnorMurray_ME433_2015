...
#pragma config FPLLODIV = DIV_4 // divide clock after FPLLMUL to get 48MHz (divide by 4)
#pragma config UPLLIDIV = DIV_12 // divider for the 8MHz input clock, then multiply by 12 to get 48MHz for USB
