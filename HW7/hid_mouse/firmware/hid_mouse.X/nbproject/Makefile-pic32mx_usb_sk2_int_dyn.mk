...
${OBJECTDIR}/_ext/102310384/sys_clk_static.o: ../src/system_config/pic32mx_usb_sk2_int_dyn/framework/system/clk/src/sys_clk_static.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/102310384/sys_clk_static.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -I"../src" -I"../src/system_config" -I"../src/system_config/pic32mx_usb_sk2_int_dyn" -I"../../../../../../framework" -I"../../../../../../framework/system/common" -I"../../../../../../framework/system/devcon" -I"../../../../../../framework/system/int" -I"../../../../../../framework/system" -I"../../../../../../framework/driver/usb" -I"../../../../../../framework/usb" -I"../src/system_config/pic32mx_usb_sk2_int_dyn/framework" -I"../../../../../../bsp/pic32mx_usb_sk2" -Werror -Wall -MMD -MF "${OBJECTDIR}/_ext/102310384/sys_clk_static.o.d" -o ${OBJECTDIR}/_ext/102310384/sys_clk_static.o ../src/system_config/pic32mx_usb_sk2_int_dyn/framework/system/clk/src/sys_clk_static.c     
